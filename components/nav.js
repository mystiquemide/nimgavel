export function renderNav(container, { activePath = "/" } = {}) {
  ...
  const isGuide = activePath === "/how-it-works";
  const isDocs = activePath === "/docs";
      ...
      <div class="shell">
        <nav class="dashed-nav" aria-label="Main Navigation">
          ...
          <ul class="nav-links">
            ...
            <li>
              <a href="/how-it-works" class="nav-link ${isGuide ? "active" : ""}">New? Start Here</a>
            </li>
            <li>
        ...
        <div class="mobile-menu-drawer" id="mobile-drawer" aria-hidden="true">
          ...
          <a href="/#your-auctions" class="mobile-link">Recent & Joined</a>
          ...
          <a href="/docs" class="mobile-link">Documentation</a>
