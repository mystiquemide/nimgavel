...
// In-app wallet recovery card. Never shown in plain browsers.
export function walletTroubleCard(retryId) {
  return `
    <div class="wallet-trouble-card">
      <p class="wallet-trouble-title">Nimiq Pay did not finish connecting.</p>
      <p class="wallet-trouble-desc">If a permission prompt is still open, approve or dismiss it there first. If nothing is showing, retry the connection.</p>
